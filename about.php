...
<body>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-10 text-background-intro">
                  <h1 class="brand-heading" style="margin-bottom:0">About Triangle</h1>
                </div>
            </div>
        </div>
      </div>
    ...
    <div  id="aboutus-page" class="container history-intro">
      <div  class="well">
        ...
        <!-- History -->
         <div class="row">
           ...
           <div class="col-lg-4 col-md-4">
             <img class="img-responsive thumbnail" src="images/founders.jpg">
           </div>
         </div>
         ...
         <div class="row">
           ...
           <div class="col-lg-4">
             <img class="img-responsive thumbnail" src="images/house.png">
           </div>
         </div>
